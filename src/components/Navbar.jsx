...
const Navbar = () => {
  ...
  return (
   <div className={`fixed w-full transition-all z-5 ${scrollActive}`}>
      <div className="container mx-auto px-4">
        <div className="navbar-box flex items-center justify-between">
          <div className="logo">
            <h1 className="text-xl sm:text-2xl font-bold" style={{fontWeight:"bold", color:"blue"}}>Ngoding.</h1>
          </div>
          <ul className={`flex gap-8 fixed top-1/2 -translate-y-1/2 flex-col px-8 py-6 rounded shadow-lg shadow-slate-300 bg-sky-400 font-bold text-white transition-all
              md:static md:shadow-none md:flex-row md:bg-transparent md:w-auto md:h-full md:translate-y-0 md:text-black md:p-0 md:m-0 md:transition-none ${menuActive}`}>
